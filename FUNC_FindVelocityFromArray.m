...
for currTraj = 1:max(TRAJECTORY(5,:)) %Go through Each Trajectory
    ...
    VELTRAJECTORY(1,baseIndex:topIndex) = smooth(TRAJECTORY(1,baseIndex:topIndex),length(TRAJECTORY)/2,'rlowess')';
    VELTRAJECTORY(2,baseIndex:topIndex) = smooth(TRAJECTORY(2,baseIndex:topIndex),length(TRAJECTORY)/2,'rlowess')';
