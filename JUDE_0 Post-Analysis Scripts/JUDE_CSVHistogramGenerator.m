...
ogName = 'AlexData.csv';
outName = 'AlexData_10degreeFilter';
...
outDir = ogDir;
ogName = 'AlexData_10degreeFilter';
...
outName = 'AlexData_10degreeFilter_WithinDeltaR.csv';
...
ogName = 'AlexData_10degreeFilter_AlongParallelAxis.csv';
mkdir(outDir);
...
ogName = 'AlexData_10degreeFilter_AlongPerpendicularAxis.csv';
