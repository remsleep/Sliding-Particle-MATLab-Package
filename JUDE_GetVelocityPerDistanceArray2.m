...
testFIELDS = {'ID','X','Y','FRAME','ORIENT','CHANNEL'};
...
[relParVel, relPerpVel, Distance, ~, ~, ~, channelVals] = JUDE_PairwiseParPerpVelocitiesSameChannelArray(velInfo, 1, deg2rad(angleCutOff));
